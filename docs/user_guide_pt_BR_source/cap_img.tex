...
\begin{figure}[!htb]
  \centering
  \subfloat[Input image]{\includegraphics[width=0.45\textwidth]{mirror_axial.png}}  \qquad
  \subfloat[Flipped image]{\includegraphics[width=0.45\textwidth]{mirror_axial_mirrored.png}}
  \hfill
...
\begin{figure}[!htb]
\centering
\includegraphics[scale=0.4]{image_reorient_window_pt.png}
