...
class Slice(object):
    ...
    def GetSlices(self, orientation, slice_number, number_slices, inverted=False):
    ...
    def get_image_slice(self, orientation, slice_number, number_slices=1, inverted=False):
