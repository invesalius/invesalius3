...
class MetadataExtractor:
    ...
    def extract_from_files(self, dicom_files: List[str]) -> Dict[str, Any]:
        ...
        logger.info(f"Extraction complete: {len(series_metadata)} series tags, "
    ...
    def _get_extraction_info(self) -> Dict[str, Any]:
        ...
        return {
            ...
            'invesalius_version': const.INVESALIUS_VERSION if hasattr(const, 'INVESALIUS_VERSION') else 'unknown'
        }
