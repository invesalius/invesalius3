...
class InnerTaskPanel(wx.Panel):
    def __init__(self, parent, navigation):
        ...
        self.input_coil1.SetToolTip(wx.ToolTip(tooltip))
        ...
        self.input_coil2.SetToolTip(wx.ToolTip(tooltip))
        ...
        self.input_coil3.SetToolTip(wx.ToolTip(tooltip))
        ...
        self.input_coil4.SetToolTip(wx.ToolTip(tooltip))
        ...
        self.input_coil5.SetToolTip(wx.ToolTip(tooltip))
