...
class VolumeToolPanel(wx.Panel):
    ...
    def OnSavePreset(self, evt):
        d = wx.TextEntryDialog(self, tr("Preset name"))
    ...
    def __init_menus(self):
        ...
        menu.Append(RAYCASTING_TOOLS, tr("Tools"), submenu)
