...
ID_ALIGN, ID_PRINT_SCREENSHOT, ID_EXIT, ID_IMPORT_OTHERS_FILES, ID_EXPORT_OTHERS_FILES, ID_ANALYZE_IMPORT, ID_ANALYZE_EXPORT] = [wx.NewId() for number in range(15)]

ID_GAUSSIAN = wx.NewId() 
ID_MEDIAN = wx.NewId() 
ID_MODE = wx.NewId() 
ID_SOBEL = wx.NewId() 
ID_HISTEQ = wx.NewId() 
